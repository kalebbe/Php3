...
<body style="background-color:#cccccc;">
    <div>
        <nav class="navbar navbar-default navigation-clean-button" style="background-color:#314265;">
            <div class="container">
                <div class="navbar-header"><a class="navbar-brand" href="#" style="color:#ffffff;">Phlick </a><button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></div>
                <div
                    ...
                    <a class="navbar-link login" href="Login" style="color:#ffffff;">Log In</a> 
                    <a class="btn btn-default action-button" role="button" href="Register" style="background-color:#63bb76;">Sign Up</a></p>
            </div>
    </div>
    </nav>
    </div>
    <form>
        <div id="HeadingDiv" style="height:600px;background-color:#cccccc;">
            <div class="jumbotron" style="background-color:#cccccc;">
                ...
                <a class="btn btn-default" type="button" href="Register" style="/*background-color:#63bb76;*/margin:5px;">Sign Up</a></p>
