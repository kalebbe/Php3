...
class ResumeController extends Controller
{
    ...
    function submitResume($uid, $jid){
        if(!$this->rd->addToCart($uid, $jid)){
            $this->func->createMsg("You have already submit a resume for this job!", 1);
        }
        else{
            $this->func->createMsg("Resume has been submitted!", 2);
        }
